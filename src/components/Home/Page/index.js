          ...
          <motion.div
            ...
            <div className={mirror ? "right" : "left"}>
              <motion.div
                ...
                <motion.h1
                  ...
                  variants={{
                    ...
                    hidden: { fontSize: 20, lineHeight: 2, fontWeight:10, color: '#fff', opacity: 0, x: (mirror ? 200 : -200) }
                }}>
                  I can do:
                </motion.h1>
                <motion.h1
                  ...
                  variants={{
                    ...
                    hidden: { fontSize: 48, lineHeight: 1, fontWeight: 400, color: '#fff', opacity: 0, x: (mirror ? 200 : -200) }
                }}>
                  {titleEng}
                </motion.h1>
                <br />
                <motion.h1
                  ...
                  variants={{
                    ...
                    hidden: { fontSize: 36, lineHeight: 1.25, fontWeight: 800, color: '#fff', opacity: 0, x: (mirror ? 200 : -200) }
                }}>
                  {titleKor}
                </motion.h1>
              </motion.div>
              ...
              <motion.div
                ...
                <motion.p initial={{ fontSize: 20, lineHeight: 1.5, color: '#f1ced9' }}>
                  {descriptionEng}
                </motion.p>
                <br />
                <br />
                <motion.p initial={{ fontSize: 16, lineHeight: 1.5, color: '#f1ced9' }}>
                  {descriptionKor}
                </motion.p>
              </motion.div>
              ...
              <motion.div
                ...
                variants={{
                  ...
                  hidden: { position: 'absolute', color: '#fff', opacity: 0, x: (mirror ? 200 : -200), right: (mirror ? 0 : 'auto') },
              }}>
                <motion.div
                  initial="hidden"
                  whileInView="visible"
